...
public class Mon3 {
    ...
    public Mon3() {
        // แสดงข้อความเมื่อชนกับ NPC3
        VBox messageBox = new VBox();
        messageBox.setPadding(new Insets(10));
        messageBox.setBackground(new javafx.scene.layout.Background(
                new javafx.scene.layout.BackgroundFill(Color.LIGHTCORAL, new javafx.scene.layout.CornerRadii(5), Insets.EMPTY)));
        
        Text messageText = new Text("You have encountered Mon3!");
