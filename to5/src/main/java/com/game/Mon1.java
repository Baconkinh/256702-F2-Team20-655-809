...
public class Mon1 {
    ...
    public Mon1() {
        // แสดงข้อความเมื่อชนกับ NPC1
        VBox messageBox = new VBox();
        messageBox.setPadding(new Insets(10));
        messageBox.setBackground(new javafx.scene.layout.Background(
                new javafx.scene.layout.BackgroundFill(Color.LIGHTGREEN, new javafx.scene.layout.CornerRadii(5), Insets.EMPTY)));
        
        Text messageText = new Text("You have encountered Mon1!");
